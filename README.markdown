...
By default, it will be installed to _/usr/local/nginx_. You can use the '__--prefix__' option to specify the root directory.
If you want to know all the _'configure'_ options, you should run '__./configure --help__' for help.
